...
export const About = () => {
    return (
        <div>
            <h4  id="about" className="font-sora text-3xl md:text-4xl font-bold text-center text-neutral-900 dark:text-neutral-50 pb-20">Sobre</h4>
            <div className="flex flex-col lg:flex-row items-center justify-center  pb-20 gap-6">
                <div className='max-w-xl flex items-center justify-center'>
                    <div className='w-10/12  flex flex-col text-justify font-inter text-base font-normal tracking-[0.25px] text-neutral-800 pb-8'>
                        <p className='font-inter text-sm xl:text-lg mb-3 text-neutral-600 dark:text-neutral-300'>
                ...
                <div className="relative w-64 h-80 z-20">
                    <div className="absolute top-0 left-6 w-full h-full bg-purple-500 rounded-lg"></div>
                    <img
                        src={foto}
                        alt="Descrição"

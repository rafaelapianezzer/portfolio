export const Header = () => {
    return (
        <div className='flex flex-col items-center justify-between py-12 px-6 sm:px-16 lg:px-120 sm:py-40 lg:py-28 2xl:py-48 h-screen'>
            <div className='md:mx-auto max-4xl'>
                <div className='text-left md:text-center lg:text-center '>
                    ...
                    <div className='mt-10 flex md:justify-center items-center gap-3 sm:gap-6 font-body'>
                        <a href='https://github.com/rafaelapianezzer' target="_blanck" className='bg-purple-600 rounded-[5px] px-3 py-2'>  <i className="fa-brands fa-github text-2xl text-purple-50"></i></a>
                        <a href='https://br.linkedin.com/in/rafaela-pianezzer-970250150' target="_blanck" className='bg-purple-600 rounded-[5px] px-3 py-2'>  <i className="fa-brands fa-linkedin text-2xl text-purple-50"></i></a>
                    </div>

                </div>
                <div className='flex items flex-col justify-end h-full items-center'>

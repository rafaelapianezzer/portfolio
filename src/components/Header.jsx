            ...
            <div className='md:mx-auto max-w-4xl flex'>
                <div className='text-left md:text-center lg:text-center flex flex-col'>
                    ...
                    <div className='mt-10 flex md:justify-center items-center gap-3 sm:gap-6 font-body'>
                        <a href='https://github.com/rafaelapianezzer' target="_blank" className='bg-purple-600 rounded-[5px] px-3 py-1'>
                            <i className="fa-brands fa-github text-2xl text-purple-50"></i>
                        </a>
                        <a href='https://br.linkedin.com/in/rafaela-pianezzer-970250150' target="_blank" className='bg-purple-600 rounded-[5px] px-3 py-1'>
                            <i className="fa-brands fa-linkedin text-2xl text-purple-50"></i>
                        </a>
                        <a href='https://br.linkedin.com/in/rafaela-pianezzer-970250150' target="_blank" className='bg-purple-600 rounded-[5px] px-3 py-2 font-sora text-purple-50'>
                            Currículo
                        </a>
                    </div>
                </div>

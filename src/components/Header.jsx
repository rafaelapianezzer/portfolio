                   ...
                   <h1 className='font-display text-4xl lg:text-5xl font-bold tracking-tight text-neutral-900 dark:text-neutral-50 '>
                    ...
                    <div className='flex flex-col mx-auto md:items-center mt-8 '>
                        ...
                        <div className='mt-10 flex md:justify-center items-center gap-3 sm:gap-6 font-body'>
                            <a href='https://github.com/rafaelapianezzer' target="_blank" className='bg-purple-600 rounded-[5px] px-3 py-1'>  <i className="fa-brands fa-github text-2xl text-purple-50"></i></a>
                            <a href='https://br.linkedin.com/in/rafaela-pianezzer-970250150' target="_blank" className='bg-purple-600 rounded-[5px] px-3 py-1'>  <i className="fa-brands fa-linkedin text-2xl text-purple-50"></i></a>
                            <a href='https://br.linkedin.com/in/rafaela-pianezzer-970250150' target="_blank" className='bg-purple-600 rounded-[5px] px-3 py-2 font-sora text-purple-50 ' >Currículo</a>
                        </div>
                </div>
            </div>
            <div className="absolute bottom-12 left-1/2 transform -translate-x-1/2 flex flex-col items-center text-neutral-400">
                <div className="animate-bounce">
                   <span className='text-xs mr-2'>Scroll</span><i className="fa-solid fa-chevron-down dark:text-purple-300"></i>
                </div>
            </div>
        </div>
    )
